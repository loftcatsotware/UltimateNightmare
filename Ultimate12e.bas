  ...
  710 DATA "You are standing on an exposed cliff    edge. It's very windy, making it        difficult to stand up. Groups of large, prehistoric looking flying reptiles fly above you. Their hooked claws swoop     above you. Exits: NORTH"
  720 DATA "You are gliding over a large mountain,  hanging from a reptile. There are no    apparent exits!"
 ...
 3110 DATA "An Arrow"
 3120 DATA "A Bow"
 3130 DATA "A huge ORC-like creature, who luckily   has not seen you yet."
 3140 DATA "A dead creature"
 3150 DATA "A Hook"
 3160 DATA "A Rope and Hook"
 3170 DATA "A Pick Axe"
 3180 DATA "A MAD MAN, who blocks a route east."
 ...
 4770 IF W1$=V$(21) AND W2$=V$(31) AND J(1)=252 AND J(2)=LC THEN HK=1:PRINT"It hits the guard in the face and sends him to the ground!":OC=OC-1:J(1)=0:J(2)=0:J(4)=LC:J(3)=LC
 ...
 4900 IF W1$=V$(2) AND LC=11 AND J(9)=251 THEN LC=13:GOSUB 6600:HK=1
 ...
 5010 IF W1$=V$(19) AND W2$=V$(34) AND J(12)=252 AND J(11)=252 AND J(13)=LC THEN HK=1:PRINT"The orc is dead.":J(13)=0:J(14)=LC:J(11)=LC:OC=OC-1
 ...
 5045 IF W1$=V$(21) AND W2$=V$(33) AND J(16)=252 AND LC=25 THEN HK=1:LC=26:OC=OC-1:J(16)=0:PRINT"It gets caught on a reptile's claw,     whichlifts you right off the ground!    PRESS A KEY..":I$=GET$:GOSUB 6600
 ...
 5125 IF W1$=V$(26) AND W2$=V$(39) AND LC=38 AND J(21)=252 THEN HK=1:PRINT"You row the boat down the river and to  the ocean. Congratulations, you have    escaped the island!":GOTO 6130
 ...
 5150 IF W1$=V$(14) AND W2$="ORC" AND J(14)=LC THEN HK=1:PRINT"A sorry sight. Still, it will be a   safer island without it."
