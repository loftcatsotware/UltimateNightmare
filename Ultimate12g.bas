   ...
   65 GOSUB 6700
   70 DIM LOC$(50):DIM J(21):DIM OBJ$(21):DIM N(50):DIM S(50):DIM E(50):DIM W(50):DIM V$(41)
   73 TC=0:TLC=1:TT=0
   74 DIM TJ(21)
   75 L=50:T=0
   80 LC=1:OC=0:B=21
 ...
 4050 FOR D=1 TO 41:READ V$(D):NEXT
 ...
 4870 IF W1$=V$(14) AND W2$=V$(32) AND (J(9)=252 OR J(9)=251 OR J(9)=LC) THEN HK=1:PRINT"They are a lot smarter than your prison clothes."
 4880 IF W1$=V$(17) AND W2$=V$(32) AND J(9)=252 THEN HK=1:OC=OC-1:PRINT"OK":J(9)=251
 4890 IF W1$=V$(18) AND W2$=V$(32) AND J(9)=251 THEN HK=1:PRINT"You have to keep some clothes on!"
 ...
 5040 IF W1$=V$(20) AND (W2$=V$(33) OR W2$=V$(36)) AND J(15)=252 AND J(10)=252 THEN PRINT"OK":HK=1:OC=OC-1:J(10)=0:J(15)=0:J(16)=252
 5045 IF W1$=V$(21) AND (W2$=V$(33) OR W2$=V$(36)) AND J(16)=252 AND LC=25 THEN HK=1:LC=26:OC=OC-1:J(16)=0:PRINT"It hooks on to a sentry drone. You hold the rope tight as you lift right off the ground!    PRESS A KEY..":I$=GET$:GOSUB 6600
 ...
 5140 IF W1$=V$(18) AND W2$=V$(41) AND J(9)<>251 THEN HK=1:PRINT"Sorry, essential items!"
 ...
 5187 IF W1$=V$(14) AND W2$="DRON" AND LC=25 THEN HK=1:PRINT"They hum over your head, spinning and searching."
 ...
 5260 IF W1$=V$(14) AND W2$="PRIS" AND (LC=1 OR LC=2 OR LC=3) THEN HK=1:PRINT"Old and filthy. If you were expecting a modern prison you would be mistaken."
 5270 IF W1$=V$(14) AND W2$="DRON" AND LC=26 THEN
 ...
 6224   IF J(9)<>251 THEN PRINT"your prison clothes"
